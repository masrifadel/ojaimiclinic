...
export default function CataractSurgeryClient() {
  return (
        ...
        <section className="relative py-20 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              >
                Advanced phacoemulsification technology for clear vision restoration
              </motion.p>
            </motion.div>
          </div>
        </section>
            ...
            >
              <div>
                <motion.h2
                  ...
                  viewport={{ once: true }}
                >
                  What is <span className="text-yellow-400">Cataract Surgery?</span>
                </motion.h2>
                <motion.p
                ...
                >
                  Cataract surgery is a procedure to remove the lens of your eye when it becomes cloudy, 
                  which can impair vision. The cloudy lens is replaced with an artificial lens called an 
                ...
                <motion.p
                  ...
                  transition={{ delay: 0.2 }}
                >
                  Our clinic uses the latest phacoemulsification technique, which uses ultrasound 
                  energy to break up the cloudy lens before removing it through a tiny incision.
                </motion.p>
              </div>
              ...
              >
                <div className="bg-gradient-to-br from-yellow-500/20 to-blue-500/20 rounded-3xl p-8 backdrop-blur-sm border border-yellow-500/30">
                  ...
                  <p className="text-gray-300">
                    State-of-the-art equipment ensures precision and safety for optimal outcomes
                  </p>
                </div>
              </motion.div>
            </motion.div>
        ...
        <section className="py-20 px-6 bg-gradient-to-b from-transparent to-yellow-500/5">
          <div className="max-w-7xl mx-auto">
            <motion.h2
              ...
              viewport={{ once: true }}
            >
              Benefits of <span className="text-yellow-400">Cataract Surgery</span>
            </motion.h2>
              ...
              {[
                {
                  ...
                  description: "Restore clear, sharp vision and reduce dependency on glasses"
                },
                {
                  icon: FaClock,
                  title: "Quick Recovery",
                  description: "Most patients return to normal activities within a few days"
                },
                {
                  icon: FaShieldAlt,
                  title: "High Success Rate",
                  description: "Over 95% success rate with minimal complications"
                },
                {
                  icon: FaUserMd,
                  title: "Experienced Surgeons",
                  description: "Board-certified ophthalmologists with extensive experience"
                },
                {
                  icon: FaHospital,
                ...
                },
                {
                  ...
                  description: "Premium lenses to correct astigmatism and presbyopia"
                }
              ].map((benefit, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  step: "1",
                  title: "Preparation",
                  description: "Eye drops are applied to dilate the pupil and numb the eye"
                },
                {
                  step: "2",
                  title: "Incision",
                  description: "A tiny incision (2.2-2.5mm) is made in the cornea"
                },
                {
                  step: "3",
                  title: "Phacoemulsification",
                  description: "Ultrasound energy breaks up the cloudy lens for removal"
                },
                {
                  step: "4",
                  title: "IOL Implantation",
                  description: "The artificial lens is folded and inserted through the incision"
                },
                {
                  step: "5",
                  title: "Completion",
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              {[
                ...
                <motion.div
                  ...
                  className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-yellow-400/50 transition-colors"
                >
                  <h3 className="text-xl font-bold mb-2 text-yellow-400">{phase.phase}</h3>
                  <p className="text-sm text-gray-400 mb-4">{phase.timeframe}</p>
